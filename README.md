...
- [node.js](https://nodejs.org/) installed (minimum v20.9.0, developed on LTS v23)
- [typescript](https://www.typescriptlang.org/) installed (developed on v5.9)
